...
build-InitDatabaseFunction:
	...
	cp Dataset/processed/city_urban_forest_trees.csv "$(ARTIFACTS_DIR)/Dataset/processed/"
	cp Dataset/processed/city_garden_bed_assets.csv "$(ARTIFACTS_DIR)/Dataset/processed/"
	cp Dataset/processed/city_garden_bed_inventory.csv "$(ARTIFACTS_DIR)/Dataset/processed/"
