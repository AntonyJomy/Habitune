  ...
  return (
    <header className="site-header">
      ...
      <div className="header-actions">
        ...
        <a className="button button-compact" href="#features">Explore my area</a>
      </div>
    </header>
  )
}
...
function PollinationCorridorSection() {
  return (
    <section
      className="content-section two-column corridor-section"
      id="pollination-corridor"
      data-node-id="17:36"
    >
      ...
      <div className="media-placeholder corridor-placeholder" aria-label="Botanical corridor illustration placeholder">
        <span className="corridor-icon-wrap" aria-hidden="true">
          <img src={flowerPlaceholderIcon} alt="" />
        </span>
...
const featureCards = [
  {
    title: 'Know your ecosystem.',
    description: 'View pollination corridors, green canopy and info on local species in and around your area of residence.',
    action: 'Explore my area',
  },
  {
    title: 'Find the right plants.',
    description: 'Find the plant species that is compatible and promotes your local biodiversity.',
    action: 'Find my plant',
  },
  {
    title: 'Plant with confidence.',
    description: 'Check if you can plant outdoors in your locality. We will help you find the right plant by verifying council guidelines.',
    action: 'Check local nature strips',
  },
]
      ...
      <div className="feature-grid" data-node-id="21:6">
        {featureCards.map((feature) => (
          <article className="feature-card" key={feature.title}>
            ...
            <button className="button feature-button" type="button">{feature.action}</button>
          </article>
        ))}
      </div>
    </section>
