// @ts-nocheck
import { locations, suburbPolygons } from '../data/mockEcosystemData'

const suburbEntries = [
  ['Carlton', 'Carlton VIC 3053', ['3053']], ['Parkville', 'Parkville VIC 3052', ['3052']],
  ['Kensington', 'Kensington VIC 3031', ['3031']], ['North & West Melbourne', 'North & West Melbourne VIC', ['3003', '3051']],
...
function findSupportedSuburb(lat, lng, displayName = '') {
  const byPolygon = suburbPolygons.find((suburb) => pointInPolygon([lat, lng], suburb.positions))
